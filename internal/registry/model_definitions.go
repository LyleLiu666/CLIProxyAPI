...
// GetCodexAllModels returns the de-duplicated union of all Codex plan tiers.
func GetCodexAllModels() []*ModelInfo {
	return uniqueModelInfos(append(append(append(
		GetCodexProModels(),
		GetCodexPlusModels()...),
		GetCodexTeamModels()...),
		GetCodexFreeModels()...))
...
func uniqueModelInfos(models []*ModelInfo) []*ModelInfo {
	if len(models) == 0 {
		return nil
	}
